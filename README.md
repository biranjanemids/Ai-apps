...
Every platform adapter falls back to bundled mock data on scrape/API failure, so the bot always answers. Set `USE_MOCK_DATA=true` for a fully offline demo.
